...
const Excite = () => {
  return (
    <div className=' bg-[#EFE0CC] w-[95%] mx-auto flex items-center gap-12 justify-between py-12 px-12 mt-32'>
       ...
       <div className=' bg-white py-3 px-3 rounded-md flex items-center'>
        ...
        <button className=' bg-black py-3 px-6 text-white w-[30%]'>Get Start</button>
       </div>
       </div>
       <img src={excite} alt="" />
    </div>
